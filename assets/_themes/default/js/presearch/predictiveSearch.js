...

{
...

	{
...

		{
			...
			{		
				...
				if(icon==""){
						...
						icon = "http://www.standardchartered.com" + icon;
		...
		if(i < num - 1){
			...
			ulStr += "<li class='lastSearch'><a href='http://www.standardchartered.com/en/search-result.html?q="+data.query+options.googleOptions+"'><span class='lastSearchSpan'>View all search results&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></a></li></ul>";
	...
	//}		
        ...
        ulStr = "<ul class='searchCategory'><li class='firstTitle'><span>No shortcut found</span></li><li class='noResult'>Try another search or click this <a href='http://www.standardchartered.com/en/search-result.html?q="+data.query+options.googleOptions+"'>link</a> to see all results for '"+data.query+"'.</li><li class='lastSearch' style='height: 20px; *margin-top: 5px; *height: 15px'></li></ul>";
...

{
	...
	var config = jQuery.extend({
		...
		searchURL: 'http://apps.standardchartered.com/presearch/getBox.action'
						...
						if(numTotal > 6)
...

							{
								...
								if(i < numTotal - 1){
									...
									ulStr += "<li class='lastSearch'><a href='http://www.standardchartered.com/en/search-result.html?q="+q+options.googleOptions+"'>view all search results ></a></li></ul>";
								...
								if(this.showResult && jQuery.trim($('#q').val()) != "" ){
									...
									ulStr = "<ul class='searchCategory'><li class='firstTitle'><span>No shortcut found</span></li><li class='noResult'>Try another search or click this <a href='http://www.standardchartered.com/en/search-result.html?q="+q+options.googleOptions+"'>link</a> to see all results for '"+q+"'.</li><li class='lastSearch' style='height: 20px; *margin-top: 5px; *height: 15px'></li></ul>";
...
function openLoadingBox() {
	...
	if ($("#searchResults").is(':hidden')) {
		...
		ulStr += "<li class='loading'><span class='imgIcon loadingImg'><img width='20' height='20' src='http://www.standardchartered.com/en/_themes/default/img/presearch/loading.gif' /></span><span class='sContent'><b></b><br></span></li>";	
