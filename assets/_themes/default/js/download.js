...
var category_list = ["Financials", "Liverpool Football Club", "Marathons", "Our brand", "Our offices","People","Policies", "Research and reports", "Sustainability"];
...
function generateContent(){
    ...
    if(list.length == 0){
	    ...
	    if(vo.summary != null){
            ...
            if(vo.objectType == 'D'){
                                 $("#downloadcentre_listing").append("<li class= '"+itemClass+"' style='padding-bottom:1.2727em'>" + "<a  href = '"+vo.filePath+"'><img src='" + vo.imageUrl + "' width='73' height='58' title='PDF' alt='PDF'></a>" +
                                                    "<div class='right' style='width:125px;margin-bottom:1px;'>" +
                                                    "<ul class='links' style='margin-bottom:1px;line-height:1em;'>" +
                                                    "<li ><a href='"+vo.filePath+"'><span>Download document</span></a></li>" +
                                                    "</ul>" +
                                                    "</div>" +
