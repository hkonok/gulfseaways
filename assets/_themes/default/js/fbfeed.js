...
$(document).ready(function(){
	...
	$.ajax({
		url: "http://ec2-23-23-229-46.compute-1.amazonaws.com:8080/jsppages/getaccesstoken.jsp?cid=149169311831203",
		dataType: "jsonp",
		jsonp : "callback",
...
/*	jsonlib.fetch('https://graph.facebook.com/oauth/access_token?type=client_cred&client_id=149169311831203&client_secret=3b213531736a81288bab810902b0a8c5', function(m) { output(m); });
	*/
	  $('#fbfeeds01').html("<div class='fbfeed-item'>Loading Feeds. Please wait...</div>");
...
$(img).bind({
    ...
    $('body').data('isfeedload', false);
    $(img).attr('src','http://profile.ak.fbcdn.net/hprofile-ak-snc4/211123_155725841111588_3516643_q.jpg');
