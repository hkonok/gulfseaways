...
element.innerHTML="";
 ...
 $(document).ready(function() {
		...
		$('#notice').load('/en/_themes/default/js/cookie.html');

		var externalLinkFeature1 = "http:";
		var externalLinkFeature2 = "https:";
		...
		if(appName == "Microsoft Internet Explorer"){
			myurl = "http://www.addthis.com/images/addthis-logo.gif?rand="+myRand;
		}else{
			myurl = "http://www.facebook.com/favicon.ico?rand="+myRand;
		}
		image.src = myurl;
		image.onload = function(){
			// The user can access addthis
			$.getScript('http://s7.addthis.com/js/250/addthis_widget.js#pubid=ra-4e1d167e73acaa0d?rand='+myRand, function(data, textStatus){
...
if(video_src.indexOf('.flv') != -1){
    ...
    videoObject += '<param name="allowscriptaccess" value="always"></param>';
