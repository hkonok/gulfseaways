...
jQuery(function ($) {
	...
	$.JL.Sharesfeed = Sharesfeed = {
		...
		_stockdata: null,
		_url: "http://apps.shareholder.com/irxml/irxml.aspx",
		_querystring: null,
	...
	$.JL.Mapmodule = Mapmodule = {
			...
			var $map = $this.parents("#map-nav").siblings("#map").animate({ "opacity": 0 }, 200, function () {
				...
				$activeMarkers.each(function (i) {
					...
					var country = $this.next().children('h3').html();
                              //added by hiSoft-julius 27102011 START
                              ...
                              //added by hiSoft-julius 27102011 END
                              //modified by hiSoft-julius 27102011 START
					...
					var listing = '<li><a target="_self" href="' + countryLink + '">' + country + '</a></li>';
                              //modified by hiSoft-julius 27102011 END
		...
		markerClickHandler: function (event) {
			...
			//$map.stop().animate({ "left": 550 }, 420, "easeOutQuad");
                  ...
                  //added by hiSoft-julius 29102011 START
                  ...
                  var middleEastCountries = "saudi_arabiasaudiarabiairanegyptbahrainjordanlebanonomanqataruaeunitedarabemirates";
                  ...
                  var europeCountries = "germanyfranceguernseyirelanditalyjerseyrussiaspainswedenswitzerlandturkeyunitedkingdomaustria";
                  var americasCountries = "miamicanadacaymanislandsbrazilchilecolombiamexicoperuusavenezuelafalklandislandsargentina";
			...
			var region = "";
                  ...
                  //added by hiSoft-julius 29102011 END
	...
	$.JL.Aux = Aux = {
		...
		init: function () {
			...
			var $table = $('table:not(.sub table, #map table)');
			if ($table.length) {
