...
/	@author j.lau@SASDesign http://www.jonathanlau.co.uk
/	@build 12.07.11
=================*/
	...
	$.JL.Forms = Forms = {
		...
		initFormNav: function ($target) {
            ...
            if($selected.length == 0){
                //$selected = $carousel.find("input[id ='search-newsmedia-category-1'], a.selected");
				$selected = $carousel.find("input");
            }
